//Source: https://rosettacode.org/wiki/Hailstone_sequence#JavaScript
...
function LongestSequenceHailstone(input){
    for (var n, max = 0, i = input; --i;) {
        var seq = hailstone(i), sLen = seq.length;
        if (sLen > max) {
            n = i;
            max = sLen;
...
module.exports.LongestSequenceHailstone = LongestSequenceHailstone;